                ...
                return (
                    ...
                    (o.prototype = {
                        ...
                        getPortionReplacementNode: function (t, n) {
                            ...
                            var a =
                                "string" == typeof r ? e.createElement(r) : r;
                            return (
                                a && o && (a.className = o),
                                (i = e.createTextNode(
                                    this.prepareReplacementString(i, t, n),
                                )).data && a
                                    ? (a.appendChild(i), a)
                                    : i
                            );
                        ...
                        replaceMatch: function (t, n, i, r) {
                            ...
                            if (a === d) {
                                ...
                                n.indexInNode > 0 &&
                                    ((o = e.createTextNode(
                                        c.data.substring(0, n.indexInNode),
                                    )),
                                ...
                                return (
                                    ...
                                    r.endIndexInNode < c.length &&
                                        ((s = e.createTextNode(
                                            c.data.substring(r.endIndexInNode),
                                        )),
                            ...
                            ((o = e.createTextNode(
                                a.data.substring(0, n.indexInNode),
                            )),
                                (s = e.createTextNode(
                                    d.data.substring(r.endIndexInNode),
                                )));
                            for (
            ...
            (t(
                ...
                t(
                    ...
                    Object.assign({}, n, {
                        find: this.REG_START,
                        replace: (e) =>
                            i("heti-spacing", "heti-spacing-start", e.text),
                    }),
                ),
                t(
                    e,
                    Object.assign({}, n, {
                        find: this.REG_END,
                        replace: (e) =>
                            i("heti-spacing", "heti-spacing-end", e.text),
                        offset: this.offsetWidth,
                    }),
                ),
                t(
                    ...
                    Object.assign({}, n, {
                        ...
                        replace: (e) =>
                            i("heti-adjacent", "heti-adjacent-half", e.text),
                        offset: this.offsetWidth,
                    }),
                ),
                t(
                    ...
                    Object.assign({}, n, {
                        ...
                        replace: (e) =>
                            i("heti-adjacent", "heti-adjacent-quarter", e.text),
                        offset: this.offsetWidth,
                    }),
                ),
                t(
