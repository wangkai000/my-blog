...
import { U as h } from "./ShadowCard-CjdMbykC.js";
const w = { class: "small-button" };
const k = e({}, [
        [
            "render",
            function (e, a) {
                return (
                    t(),
                    o("div", w, [l(e.$slots, "default", {}, void 0, !0)])
                );
            },
        ],
        ["__scopeId", "data-v-559823c5"],
    ]),
    _ = (e) => (C("data-v-71058bdd"), (e = e()), b(), e),
    y = {
    ...
    U = { class: "pointer-events-auto p-0 md:p-[1.5em]" },
    z = { class: "mb-4 flex flex-row items-center justify-between" },
    B = { class: "text-[1.25rem] font-bold" },
    I = ["src"],
    P = { class: "flex flex-row justify-between gap-[20px] p-0 md:p-[1.5em]" },
    q = { class: "truncate" },
    A = { class: "flex flex-shrink-0 flex-row gap-4" },
    F = _(() =>
        i(
            "svg",
            {
                                                ...
                                                (e) => (
                                                    ...
                                                    f(
                                                        h,
                                                        {
                                                            key: e.name,
                                                            style: {
                                                                border: "5px solid var(--blog-card-border)",
                                                            },
