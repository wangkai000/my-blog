...
const V = (e) => (f("data-v-3b54f7f2"), (e = e()), k(), e),
    E = { class: "py-6 px-4 sm:px-6 lg:px-8" },
    J = { class: "max-w-5xl mx-auto" },
    S = V(() =>
        c(
            "div",
    ...
    L = { class: "flex justify-center my-6" },
    N = { class: "flex flex-wrap items-center gap-3 max-w-3xl mx-auto" },
    Q = { class: "flex flex-wrap gap-2" },
    M = ["onClick"],
    j = {
        class: "text-sm font-medium text-gray-600 dark:text-gray-300 flex items-center ml-2",
    },
    z = { class: "max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6" },
    F = {
    ...
    _ = { class: "p-6 bg-gray-50 dark:bg-gray-800" },
    A = { class: "mb-4" },
    H = {
    ...
    R = { class: "mt-4 flex flex-wrap gap-2" },
    X = {
        key: 0,
            ...
            setup(a) {
                const f = [
                    ...
                    ee = l(() => {
                        const e = new Set();
                        return (
                            f.forEach((a) => a.tags.forEach((a) => e.add(a))),
                            Array.from(e)
                        );
                    });
                function ae() {
                ...
                const te = () => ae(),
                    le = l(() =>
                        0 === B.value.length
                            ? [...f]
                            : f.filter((e) =>
                                  B.value.some((a) => e.tags.includes(a)),
                              ),
                    ),
                    ie = l(() => Math.ceil(le.value.length / 1)),
                    re = l(() => {
                        var e;
                        if (V.value) {
                            const a = f.find((e) => e.bvid === V.value);
                            (null == (e = null == a ? void 0 : a.player) ||
                                e.postMessage(
                        ...
                        k.value > ie.value && (k.value = 1);
                        const a = 1 * (k.value - 1);
                        return le.value.slice(a, a + 1);
                    });
                function se(e) {
                    const a = document.querySelector(
                        `iframe[title="${e.title}"]`,
                    );
                    (null == a ? void 0 : a.contentWindow) &&
                        ((e.loaded = !0),
                        (e.player = a.contentWindow),
                        (e.origin = new URL(a.src).origin));
                }
                function oe(e) {
                    try {
                        const t = JSON.parse(e.data);
                        if ("bilibili-player" === t.from && t.bvid) {
                            const e = f.find((e) => e.bvid === t.bvid);
                            if (!e) return;
                            "play" === t.cmd &&
                                V.value !== e.bvid &&
                                ((a = e.bvid),
                                f.forEach((e) => {
                                    if (e.bvid !== a && e.player && e.origin)
                                        try {
                                            (e.player.postMessage(
                                                JSON.stringify({
                                                    cmd: "pause",
                                                }),
                                                "*",
                                        ...
                                        c("div", N, [
                                            c("div", Q, [
                                                c(
                                                    ...
                                                    {
                                                        class: b([
                                                            "px-3 py-1.5 rounded-full text-xs transition-all flex items-center gap-1 hover:shadow-md",
                                                            0 === B.value.length
                                                                ...
                                                                ? (u(),
                                                                  g("div", C, [
                                                                      c(
                                                                          "iframe",
                                                                          {
                                                                              src: `//player.bilibili.com/player.html?isOutside=true&bvid=${a.bvid}&page=1&autoplay=0`,
                                                                              scrolling:
                                                                                  "no",
                                                                              border: "0",
                                                                              frameborder:
