...
const d = { class: "inner-box-1" },
    ...
    b = s(
        "div",
        { class: "relative grid w-fit place-items-center" },
        [
            s("div", { class: "opacity-0" }, ":"),
            s("div", { class: "absolute left-[1px] top-0 w-full" }, "."),
        ],
        -1,
    ),
    _ = {
        ...
        setup(t) {
            ...
            function l() {
                const t = new Date().getFullYear(),
                    e = 29 === new Date(t, 2, 0).getDate() ? 366 : 365,
                    a = (
                        ((Math.floor(
                            (new Date().getTime() -
                                new Date(t, 0, 0).getTime()) /
                                864e5,
                        ) +
                            1) /
                            e) *
            ...
            return (
                ...
                (t, l) => {
                    ...
                    return (
                        ...
                        i(
                            n,
                            { class: "h-[300px] w-[400px] text-[5rem]" },
                            {
                                default: p(() => [
                                    s("div", D, [
                                        s("span", g, [
