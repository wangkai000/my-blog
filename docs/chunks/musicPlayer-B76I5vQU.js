import { Y as e, b9 as n, i as t } from "../assets/app-C1iy-c1N.js";
var o,
    r = {};
/*!
 *  howler.js v2.2.4
    ...
    (function () {
                ...
                if (
                    ...
                    for (var o = 0; o < n._howls.length; o++)
                        if (!n._howls[o]._webAudio)
                            for (
                                var r = n._howls[o]._getSoundIds(), a = 0;
                                a < r.length;
                                a++
                            ) {
                    ...
                    var n = function (t) {
                        ...
                        for (var r = 0; r < e._howls.length; r++)
                            if (!e._howls[r]._webAudio)
                                for (
                                    var a = e._howls[r]._getSoundIds(), i = 0;
                                    i < a.length;
                                    i++
                                ) {
        ...
        r.prototype = {
            ...
            load: function () {
                ...
                if (t.noAudio) e._emit("loaderror", null, "No audio support.");
                    ...
                    for (var o = 0; o < e._src.length; o++) {
                        var r, i;
                        if (e._format && e._format[o]) r = e._format[o];
                        else {
            ...
            play: function (e, n) {
                ...
                var s = Math.max(
                        0,
                        u._seek > 0 ? u._seek : o._sprite[e][0] / 1e3,
                    ),
                    _ = Math.max(
                        0,
                        (o._sprite[e][0] + o._sprite[e][1]) / 1e3 - s,
                    ),
                    ...
                    if (o._webAudio) {
                        var v = function () {
                            ...
                            (m.gain.setValueAtTime(e, t.ctx.currentTime),
                                (u._playStart = t.ctx.currentTime),
                                void 0 === m.bufferSource.start
                                    ? u._loop
                                        ? m.bufferSource.noteGrainOn(
                                              0,
                                              s,
                                              86400,
                                          )
                        ...
                        if (m.readyState >= 3 || A) h();
                            ...
                            (m.addEventListener(t._canPlayEvent, y, !1),
                                o._clearTimer(u._id));
                        }
                    }
                    return u._id;
                ...
                for (var r = o._getSoundIds(n), a = 0; a < r.length; a++) {
                    ...
                    i &&
                        ...
                        o._webAudio && i._node
                            ...
                            : i._node && (i._node.muted = !!t._muted || e),
                        o._emit("mute", i._id));
                }
                return o;
            },
            volume: function () {
                ...
                if (
                    ...
                    return (o = n ? r._soundById(n) : r._sounds[0])
                        ? o._volume
                        : 0;
                ...
                for (var i = 0; i < n.length; i++)
                    (o = r._soundById(n[i])) &&
                        ...
                        r._webAudio && o._node && !o._muted
                            ? o._node.gain.setValueAtTime(e, t.ctx.currentTime)
                            : o._node &&
                              !o._muted &&
                              (o._node.volume = e * t.volume()),
            ...
            fade: function (e, n, o, r) {
                ...
                for (var i = a._getSoundIds(r), u = 0; u < i.length; u++) {
                    ...
                    if (d) {
                        if (
                            (r || a._stopFade(i[u]), a._webAudio && !d._muted)
                        ) {
            ...
            loop: function () {
                ...
                if (1 === r.length) {
                    if ("boolean" != typeof r[0])
                        return (
                            !!(t = o._soundById(parseInt(r[0], 10))) && t._loop
                        );
                    ((e = r[0]), (o._loop = e));
                ...
                for (var a = o._getSoundIds(n), i = 0; i < a.length; i++)
                    (t = o._soundById(a[i])) &&
                        ...
                        o._webAudio &&
                            ...
                            e &&
                                ((t._node.bufferSource.loopStart =
                                    t._start || 0),
                                (t._node.bufferSource.loopEnd = t._stop),
                                o.playing(a[i]) &&
                                    (o.pause(a[i], !0), o.play(a[i], !0)))));
                return o;
            },
            rate: function () {
                var e,
                ...
                for (var i = 0; i < n.length; i++)
                    if ((o = r._soundById(n[i]))) {
                        (r.playing(n[i]) &&
                            ((o._rateSeek = r.seek(n[i])),
                            (o._playStart = r._webAudio
                                ? t.ctx.currentTime
                                : o._playStart)),
                            (o._rate = e),
                        ...
                        var u = r.seek(n[i]),
                            d =
                                (1e3 *
                                    ((r._sprite[o._sprite][0] +
                                        r._sprite[o._sprite][1]) /
                                        1e3 -
                                        u)) /
                                Math.abs(o._rate);
                        ((!r._endTimers[n[i]] && o._paused) ||
                            (r._clearTimer(n[i]),
                            (r._endTimers[n[i]] = setTimeout(
                                r._ended.bind(r, o),
                                d,
                            ))),
                            r._emit("rate", o._id));
            ...
            seek: function () {
                ...
                if (
                    (0 === r.length
                        ? o._sounds.length && (n = o._sounds[0]._id)
                        : 1 === r.length
                          ? o._getSoundIds().indexOf(r[0]) >= 0
                              ? (n = parseInt(r[0], 10))
                              : o._sounds.length &&
                                ((n = o._sounds[0]._id), (e = parseFloat(r[0])))
                          : 2 === r.length &&
            ...
            _emit: function (e, n, t) {
                for (
                    var o = this, r = o["_on" + e], a = r.length - 1;
                    a >= 0;
                    a--
                )
            ...
            _cleanBuffer: function (e) {
                var n =
                    t._navigator && t._navigator.vendor.indexOf("Apple") >= 0;
        ...
        var i = {},
            u = function (e) {
                var n = e._src;
                if (i[n]) return ((e._duration = i[n].duration), void _(e));
            ...
            s = function (e, n) {
                ...
                1 === t.ctx.decodeAudioData.length
                    ? t.ctx.decodeAudioData(e).then(r).catch(o)
                    : t.ctx.decodeAudioData(e, r, o);
            },
            _ = function (e, n) {
                        ...
                        (t._pannerAttr = {
                            ...
                            panningModel:
                                void 0 !== n.panningModel
                                    ...
                                    : "HRTF",
                            refDistance:
                                void 0 !== n.refDistance ? n.refDistance : 1,
                            rolloffFactor:
...
const a = n("musicPlayer", () => {
    ...
    n.value >= a.value.length && (n.value = 0);
    let i = null;
    function u() {
        (i && (i.stop(), i.unload(), (i = null)),
            (i = new r.Howl({
                src: [a.value[n.value].url],
                html5: !0,
                volume: o.value,
                onplay: () => {
                    e.value = !0;
                ...
                onloaderror: (t, o) => {
                    (console.error("音乐加载失败:", o, "当前曲目:", n.value),
                        (e.value = !1));
                },
                onplayerror: (t, o) => {
                    (console.error("音乐播放失败:", o, "当前曲目:", n.value),
                        (e.value = !1));
                },
            })));
    }
    function d() {
        ((n.value = (n.value + 1) % a.value.length),
            i && (i.stop(), i.unload(), (i = null)),
            u(),
            i && (i.volume(o.value), i.play(), (e.value = !0)));
    }
    return {
        isPlaying: e,
        currentTrack: n,
        ...
        togglePlay: function () {
            (i || u(),
                i && (e.value ? i.pause() : (i.volume(o.value), i.play())));
        },
        nextTrack: d,
        prevTrack: function () {
            ((n.value = (n.value - 1 + a.value.length) % a.value.length),
                i && (i.stop(), i.unload(), (i = null)),
                u(),
                i && (i.volume(o.value), i.play(), (e.value = !0)));
        },
        increaseVolume: function () {
            ((o.value = Math.min(1, o.value + 0.1)),
                null == i || i.volume(o.value));
        },
        decreaseVolume: function () {
            ((o.value = Math.max(0, o.value - 0.1)),
                null == i || i.volume(o.value));
        },
        setVolume: function (e) {
            ((o.value = e), null == i || i.volume(e));
        },
