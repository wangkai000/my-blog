...
import { I as x } from "./iconify-DqZr0ymk.js";
const y = { class: "max-w-6xl mx-auto px-4 py-8" },
    I = {
        class: "mb-10 bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700",
    },
    k = { class: "flex flex-wrap items-center justify-between mb-4 gap-3" },
    A = { class: "text-xl font-bold text-gray-800 dark:text-gray-200" },
    W = { class: "flex items-center space-x-2" },
    C = { class: "flex flex-wrap gap-2" },
    U = ["onClick"],
    T = { class: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6" },
    j = ["href"],
    G = { class: "p-6 h-full flex flex-col" },
    ...
    B = ["src", "onError"],
    R = { class: "ml-4 flex-1" },
    N = { class: "text-xl font-bold text-white line-clamp-2" },
    F = { class: "flex flex-wrap mb-3" },
    S = { class: "text-white/90 flex-grow line-clamp-4" },
    L = { key: 0, class: "flex items-center justify-center mt-10 gap-4" },
    M = ["disabled"],
    _ = {
    ...
    H = f(
        t({
            ...
            setup(t) {
                ...
                const et = e(1),
                    ot = e(21),
                    at = o(() => Math.ceil(Z.value.length / ot.value)),
                    st = o(() => {
                        const t = (et.value - 1) * ot.value,
                            e = t + ot.value;
                        return Z.value.slice(t, e);
                    });
                function it() {
                    et.value > 1 && et.value--;
                }
                function ct() {
                    et.value < at.value && et.value++;
                }
                return (
                    a(
                        Y,
                                            ...
                                            (t) => (
                                                ...
                                                i(
                                                    "button",
                                                    {
                                                        key: t,
                                                        class: g([
                                                            "transition-all px-4 py-2 rounded-full text-sm font-medium hover:scale-105 duration-200",
                                                            [
                                                                Y.value.includes(
                                                                    t,
                                                                )
                            ...
                            at.value > 1
                                ? (s(),
                                  i("div", L, [
                                      ...
                                      c("span", _, n(et.value), 1),
                                      c(
                                          "button",
                                          {
                                              disabled: et.value === at.value,
                                              class: "w-12 h-12 rounded-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex items-center justify-center",
                                              onClick: ct,
                                          },
                                          [
