...
const d = {
    ...
    fitness: [
        ...
        { text: "Sweat is just fat crying.", author: "Motivate-quotes" },
        {
            text: "The only bad workout is the one that didn’t happen.",
            author: "Motivate-quotes",
        },
...
var c = {
    quotes: d,
    categories: Object.keys(d).reduce(
        (e, t) => ((e[t.toLowerCase()] = t), e),
        {},
    ),
};
const { quotes: g, categories: y } = c;
var m = {
    getQuotes: function ({
        author: e = !0,
        numberOfQuotes: t = 1,
        ...
        if (!y[a])
            throw new Error(
                `Category '${o}' not found. Available categories are: ${Object.keys(y).join(", ")}.`,
            );
        return g[y[a]]
            .sort(() => 0.5 - Math.random())
            .slice(0, t)
            .map((t) => (e ? t : { text: t.text }));
    },
    getRandomQuote: function (e) {
        const t = e ? e.toLowerCase() : null;
        if (e && !y[t])
            throw new Error(
                `Category '${e}' not found. Available categories are: ${Object.keys(y).join(", ")}.`,
            );
        const o = e ? [y[t]] : Object.keys(g),
            a = o[Math.floor(Math.random() * o.length)];
        return g[a][Math.floor(Math.random() * g[a].length)];
    },
    getDayOfQuote: function () {
        const e = new Date(),
            t = e.getDate() % Object.keys(g).length,
            o = Object.keys(g)[t],
            a = e.getDate() % g[o].length;
        return g[o][a];
    },
};
const { getQuotes: f, getRandomQuote: w, getDayOfQuote: b } = m;
var p = { getQuotes: f, getRandomQuote: w, getDayOfQuote: b };
const x = (e) => (h("data-v-ce3faa0e"), (e = e()), u(), e),
    v = {
        class: "fixed mt-40 mb-40 inset-0 flex items-center justify-center z-1",
    },
    k = {
    ...
    J = l(
        e({
            ...
            setup(e) {
                ...
                function d() {
                    !(function (e) {
                        ...
                        try {
                            ...
                            t.quote && t.author
                                ? ((h.value = t.quote), (u.value = t.author))
                                : t.text && t.author
                                  ? ((h.value = t.text), (u.value = t.author))
                                  : t.text
                                    ? ((h.value = t.text),
                                      (u.value = t.by || "Unknown"))
                                    : ((h.value = String(t)), (u.value = ""));
                        } catch {
                            ...
                            o > 0
                                ? ((h.value = t.substring(0, o).trim()),
                                  (u.value =
                                      t.substring(o + 1).trim() || "Unknown"))
                                : ((h.value = t), (u.value = "Unknown"));
                        }
                    })(
                        Math.random() < 0.01
                ...
                function c() {
                    const e = document.querySelector(".quote-content"),
                        t = document.querySelector(".quote-author");
                    (e && e.classList.add("opacity-0", "scale-95"),
