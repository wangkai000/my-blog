...
<template>
  <div class="music-bento-component p-3 h-full flex flex-col justify-center">
    <h3 class="text-sm font-bold mb-3 text-center">
      音乐播放器
    </h3>
    ...
    <div class="flex flex-col gap-3">
      <div class="flex items-center justify-between">
        ...
        <button class="play-btn flex-shrink-0" @click="musicStore.togglePlay" @error="handlePlayError">
      ...
      <div class="track-title text-sm whitespace-nowrap overflow-hidden text-ellipsis text-center">
        {{ musicStore.tracks[musicStore.currentTrack]?.title || '未知曲目' }}
        <div v-if="musicStore.tracks[musicStore.currentTrack]?.artist" class="track-artist text-xs text-gray-300">
