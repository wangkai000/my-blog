    ...
    <div class="min-h-screen flex flex-col">
                        ...
                        >
                            ...
                            >
                                <img
                                    ...
                                    @click="
                                        openImageViewer(postIndex, imgIndex)
                                    "
                                    @error="
                                        handleImageError(
                                            $event,
        ...
        >
            ...
            >
                <!-- 图片 -->
                <div
                    class="relative flex items-center justify-center max-w-full max-h-[90vh]"
                >
                    <img
                        v-if="
                            !isImageFailed(
                                `viewer-${currentPostIndex}-${currentImageIndex}`,
                            )
                        "
                        :src="currentImage"
                        alt="大图预览"
